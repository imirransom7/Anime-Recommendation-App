...
#     # References to the AnimeDataset Model; initiating the relationship
#     genre = db.relationship('AnimeGenres', backref='anime_dataset')
#     images = db.relationship('AnimeImages', backref='anime_dataset')
#
#
